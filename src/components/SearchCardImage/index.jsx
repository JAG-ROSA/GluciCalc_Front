    ...
    if (data.selected_images !== undefined) {
      if (data.selected_images.front !== undefined) {
        if (data.selected_images.front.display.fr !== undefined) {
          return (<Card.Img variant="top" src={data.selected_images.front.display.fr} className="productImage" alt="Image of the product" />);
        }
      }
    }
    return (<Card.Img variant="top" src={Image} className="productImage" alt="Image of the product missing" />);
  })()
);
